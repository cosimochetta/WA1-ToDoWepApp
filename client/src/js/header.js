...
const check_icon = <svg className="bi bi-check-circle mx-2" width="1.8em" height="1.8em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const user_icon = <svg className="bi bi-people-circle" width="30" height="30" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  return (<>
    <Navbar bg="primary" variant="dark" expand="sm" fixed="top">
      ...
      <Nav className="ml-md-auto">
        ...
        {
          props.logged &&
          <Button className='btn btn-secondary' size="sm" onClick={props.userLogout}>Logout</Button>
        }
